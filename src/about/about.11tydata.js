module.exports = {
  intro: "I recently graduated from the University of Sheffield with an M.Sc. in Cybersecurity and AI. I am currently looking for roles in AI Engineering and Research, while independently studying spiking neural networks as I prepare for Ph.D. applications in neuromorphic algorithms.",
  body: [
  ...
  education: [
    { 
      ...
      period: "2024\u20132025", 
      thesis: "SNN model of Hippocampal Reverse Replay for Reinforcement Learning", 
      grade: "Distinction",
      modules: [
        {
          semester: "Semester 1",
          modules: [
            "COM6017 Cyber Threat Hunting and Digital Forensics",
        ...
        },
        {
          ...
          modules: [
            "COM6016 Cybersecurity and AI Dissertation Project"
          ]
        }
      ]
    },
    { 
      ...
      period: "2021\u20132024", 
      thesis: "Large Language Model-based Intrusion Detection", 
      grade: "First-class",
      modules: [
        { 
          year: "Year 1",
          modules: [
            "Direct entry via APL — 120 credits recognised (SCQF L7)"
          ]
        },
        {
          year: "Year 2",
